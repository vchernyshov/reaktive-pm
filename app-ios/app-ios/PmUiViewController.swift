...
class PmUiViewController<PM: PresentationModel>: UIViewController, PmView {
            
    private lazy var delegate: PmUiViewControllerDelegate = {
        return PmUiViewControllerDelegate<PresentationModel, PmUiViewController>(pmController: self, pmView: self)
    }()
