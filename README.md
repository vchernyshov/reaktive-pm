...
- Implemented control to deal with loading and paging data(This port of [Reactive Paging and Loading](https://github.com/MobileUpLLC/RxPagingLoading) library based on [Reaktive](https://github.com/badoo/Reaktive))
